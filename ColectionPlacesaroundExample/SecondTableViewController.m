...
- (void)viewDidLoad {
   ...
   NSString  *StrCurrentLongitude=[NSString stringWithFormat: @"%f", location.coordinate.longitude]; // string value
   NSString   *StrCurrentLatitude=[NSString stringWithFormat: @"%f", location.coordinate.latitude]; // string value
        NSLog(@"%@",_tempstring);
